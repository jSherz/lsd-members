...
describe('DashboardService', () => {
  ...
  it('returns the basic info', inject([DashboardService], (service: DashboardService) => {
  ...
  it('returns null when the user is not authenticated', inject([Http], (http: Http) => {
    const jwtService = new StubJwtService(null, false);
    const service = new DashboardServiceImpl(http, jwtService, 'sdookkan.asfef.agfgdf');

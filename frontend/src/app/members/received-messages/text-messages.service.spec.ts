...
import {TextMessagesService, TextMessagesServiceImpl} from './text-messages.service';
...
describe('TextMessagesService', () => {
  ...
  it('should be created', inject([TextMessagesService], (service: TextMessagesService) => {
